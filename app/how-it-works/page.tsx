      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-8 py-24 sm:py-32">
        <div className="text-center mb-20">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
            A seamless three-step process built to minimize delays between
        ...
        <div className="relative">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8">
            <div className="flex flex-col items-center max-w-sm text-center relative">
              ...
              <div className="bg-brand-red text-white text-xs font-black uppercase tracking-wider py-1 px-3 rounded-full mb-4">
                Step 1
              </div>
              <h3 className="text-2xl font-bold mb-3">Capture & Upload</h3>
              <p className="text-slate-600 dark:text-slate-400">
                Ensure safety first, then snap clear photos of the accident.
                Upload them securely via our public portal or logged-in account
                without navigating confusing menus.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center max-w-sm text-center relative">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Our advanced computer vision models instantly scan the images to
                determine accident severity, structural damage, and potential
                injury likelihood on a 1-100 scale.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center max-w-sm text-center relative">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Based on severity thresholds, emergency responders (paramedics,
                police) are automatically dispatched to your geolocation.
                Real-time updates track their arrival.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-32 text-center">
          <Link
            href="/reports/create"
            className="inline-flex px-8 py-4 rounded-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold hover:scale-105 transition-transform shadow-xl text-lg"
          >
            Start a Report Now
          </Link>
        </div>

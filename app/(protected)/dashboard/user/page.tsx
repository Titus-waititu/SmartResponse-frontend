          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link
                  href="/reports/create"
                  className="text-sm text-brand-red font-medium hover:underline flex items-center gap-1"
                >
                  See all reports
                </Link>
              </div>
              ...
              <div className="flex flex-col items-center justify-center p-8 border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-slate-800/50">
                ...
                <p className="text-slate-500 text-sm text-center mb-6 max-w-sm">
                  Use our AI-powered reporting tool to submit photos and
                  automatically alert emergency services.
                </p>
                <Link
                  href="/reports/create"
                  className="px-6 py-3 bg-brand-red hover:bg-red-600 text-white font-semibold rounded-xl transition shadow-lg shadow-red-500/20"
                >
                  Report New Accident
                </Link>
              </div>
            ...
            <div className="bg-slate-900 rounded-2xl shadow-xl p-6 text-white border border-slate-800 relative overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <div className="text-sm font-medium">
                    Severe Lacerations, Possible Fractures
                  </div>
                </div>
                <div>
                  <div className="text-xs text-slate-400 font-semibold uppercase mb-1">
              ...
              <div className="bg-white/5 rounded-xl p-4 mb-6 border border-white/10">
                ...
                <div className="flex items-center justify-between">
                  <div className="text-sm font-medium">
                    Ambulance, Airbag Deployment
                  </div>
                  <span className="px-3 py-1 bg-brand-red text-white text-xs font-bold rounded-lg shadow-lg shadow-red-500/20">
                    Dispatched
                  </span>
                </div>
              </div>

              <h3 className="text-sm font-bold uppercase tracking-wider mb-4 border-b border-white/10 pb-2">
                Realtime Timeline
              </h3>

  ...
  return (
    <header className="absolute top-0 w-full flex items-center justify-between px-8 py-5 z-50">
      <Link href="/" className="flex items-center gap-2">
        ...
        <span className="font-bold text-lg tracking-tight hover:text-brand-red transition">
      ...
      <nav className="hidden md:flex items-center gap-8 font-medium text-sm text-slate-600 dark:text-slate-300">
        <Link href="/features" className="hover:text-brand-red transition">
          Features
        </Link>
        <Link href="/how-it-works" className="hover:text-brand-red transition">
          How It Works
        </Link>
        <Link href="/dashboard" className="hover:text-brand-red transition">
          Dashboard
        </Link>
